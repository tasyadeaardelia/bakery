        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h5 class="page-title">Create new about</h5>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            ...
                            @csrf
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" readonly value="TENTANG KAMI" name="title" placeholder="TENTANG KAMI">
                                </div>
                                <div class="form-group mb-4">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" name="address" class="form-control border-0" placeholder="alamat" id="address" required value="{{ old('address') }}">
